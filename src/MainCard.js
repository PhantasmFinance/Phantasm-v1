...
export const MainCard = ({ _asset, _protocol, _totalTokensLocked, _totalUSDLocked }) => {
  ...
  return (
    <div className="app">
      <Box rounded="20px" overflow="hidden" bg={colorMode === "dark" ? "gray.700" : "gray.200"} mt={10} boxShadow="dark-lg">
        <Center>
        ...
        <Box p={5}>
          <Stack align="center">
            ...
            <Badge variant="solid" colorScheme={aaveColorScheme} rounded="full" px={2}>
              Protocol: AAVE
            </Badge>
          </Stack>
          <Stack align="center">
          ...
          <Center>
            <Button onClick={openlong} p={3} variant="solid" colorScheme="green" size="l" mt={5} bgGradient="linear(to-r, #9D8DF1, #B8CDF8, #1CFEBA)" boxShadow="lg" fontSize="30px">
              Enter Position
            </Button>
          </Center>
        </Box>
